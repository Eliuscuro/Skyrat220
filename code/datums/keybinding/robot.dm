...
/datum/keybinding/robot/moduleone
	hotkey_keys = list("1")
	name = "module_one"
	full_name = "Переключить модуль 1"
	description = "Включает и выключает первый модуль"
...
/datum/keybinding/robot/moduletwo
	hotkey_keys = list("2")
	name = "module_two"
	full_name = "Переключить модуль 2"
	description = "Включает и выключает второй модуль"
...
/datum/keybinding/robot/modulethree
	hotkey_keys = list("3")
	name = "module_three"
	full_name = "Переключить модуль 3"
	description = "Включает и выключает третий модуль"
...
/datum/keybinding/robot/unequip_module
	hotkey_keys = list("Q")
	name = "unequip_module"
	full_name = "Снять модуль"
	description = "Снимает активный модуль"
...
/datum/keybinding/robot/undeploy
	...
	hotkey_keys = list("=")
	name = "undeploy"
	full_name = "Отключиться от оболочки"
	description = "Возвращает тебя в твоё ядро ИИ"
